  ...
  const team: StaffMember[] = [
    {
      ...
      imageAlt: 'Kerry Clark engaging a young student with shape puzzle activities during an early intervention session',
    ...
    },
    {
      ...
      imageAlt: 'Bright Hope early education teacher walking alongside a student on sensory stepping tiles',
    ...
    },
    {
      ...
      imageSrc: '/assets/images/hero-girl-physical-therapy.jpg',
